...
<div class="form-group">
    <form action='toChgStaff.do' method="post" id="formPost" class="js-form-validate">
        ...
        <div class="form-group">
            ...
            <div>
                <input id="uname" type="text" class="form-control" name="account"
                       value="${staff.account }" placeholder="给我个名字" maxlength="10">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="">
                <label class="radio-inline">
                    ...
                    <c:if test="${staff.sex=='男'}"> checked='checked'</c:if> value="男"> 男
                </label>
                <label class="radio-inline">
                    <input type="radio" name="sex"
                    <c:if test="${staff.sex=='女'}"> checked='checked'</c:if> value="女"> 女
                </label>
                <label class="radio-inline">
                    <input type="radio" name="sex"
                    <c:if test="${staff.sex=='保密'}"> checked='checked'</c:if> value="保密"> 保密
                </label>
            </div>
        </div>
        <%--<div class="form-group">--%>
        ...
        <%--</div>--%>
        <div class="form-group">
            <label for="pwd" class=" control-label">登录密码:</label>

            <div class="">
                <input id="pwd" type="password" class="form-control" name="password" value="${staff.password }"
                       placeholder="给我个密码" maxlength="10">
            </div>
        </div>
        ...
        <div class="input-bg form-group">
            ...
            <select name="position" id="product-line" class="form-control">
                ...
                <option value="职业发展顾问" <c:if test="${staff.position=='职业发展顾问'}"> selected='selected'</c:if>>职业发展顾问
                </option>
        ...
        <div class="form-group">
            ...
            <div class="">
                ...
                <input required="true" type="text" class="form-control form-datetime" name="entryTime" value="${time }"
                       placeholder="我什时候进来的">
            </div>
        </div>
        <%--<div class="form-group">--%>
        ...
        <div class="form-group">
            ...
            <div class="">
                <input id="email" type="text" class="form-control" name="email" value="${staff.email }"
                       placeholder="我的易麦鸥是什么">
            </div>
        </div>
    </form>
</div>
...
<script src="<%=basePath %>plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.zh-CN.js"
        charset="UTF-8"></script>
<script src="<%=basePath %>plugins/jquery-validation/jquery.validate.min.js"></script>
<script src="<%=basePath %>js/edit-staff-form.js"></script>
