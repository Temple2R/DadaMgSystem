    ...
    <header class='header'>
        ...
        <div class='btn-action'>
           ...
           <!--  <div class="btn-group">
            ...
            <a class='btn btn-primary ml10'>欢迎:${user.name}</a>
            <a href='logOut.do' class='btn btn-primary ml10'>退出登录</a> 
        </div>
    </header>
    <section class='row index-content' id='js-camp1'>
        <!--训练营-->
    ...
    $.ajax({
        ...
        success: function (msg) {
                ...
                "<div class='training-camp'>"+
                    ...
                    "<div class='training-camp-title'>"+
                        ...
                        "<div class='action text-right mr10'>"+
                            "<a class='btn btn-primary'href='findIdCamp.do?id="+list.id+"'>编辑</a>"+
            ...
            $(".index-item").click(function(){
            	location.href= "toCamp.do?id="+list.id;
            })
        },
        error: function () {
