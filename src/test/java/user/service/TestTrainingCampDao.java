...
public class TestTrainingCampDao {
	...
	@Test
	public void test3(){
		int temp=trainingCampDao.deleteTrainingCamp(4);
		System.out.println(temp);
	}
	
	@Test
	public void test4(){
		TrainingCamp tc=trainingCampDao.findTrainingCampByClassNumber(102);
		tc.setTeacherName("小飞飞");
	...
	@Test
	public void test5(){
		System.out.println(trainingCampDao.findAll());
	}
}
